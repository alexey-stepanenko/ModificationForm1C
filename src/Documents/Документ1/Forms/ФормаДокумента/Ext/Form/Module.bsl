...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	МакетОписанияМодификацийМетаданные = Метаданные.Обработки.ОписанияМодификацийФорм.Макеты.Документ1_ФормаДокумента;
	МакетОписанияМодификаций = МодификацияФорм.МакетОписанияМодификаций(МакетОписанияМодификацийМетаданные);
	МодификацияФорм.МодифицироватьФорму(ЭтаФорма, Отказ, МакетОписанияМодификаций);
КонецПроцедуры
