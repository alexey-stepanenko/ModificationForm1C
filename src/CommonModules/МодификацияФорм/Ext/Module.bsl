	...
	Для Каждого ЭлементКоллекции Из КоллекцияЭлементов Цикл
		...
		Если ЭлементФормы <> Неопределено Тогда
			Если ТипЗнч(ЭлементФормы) <> ОписаниеЭлемента.ТипЭлемента Тогда
				ВызватьИсключение НСТр("ru='Некорректный тип элемента'");
			КонецЕсли;
		Иначе
		...
		ЗаполнитьЗначенияСвойств(ЭлементФормы, ОписаниеЭлемента.СвойстваЭлемента);
...
Функция ЗначенияСвойствЭлемента(ОписаниеЭлемента)
	...
	ОписаниеСвойствЭлементаФормы = МодификацияФормОбработкаСвойствЭлементаПовтИсп.ОписанияСвойствЭлементовФормы().Получить(ОписаниеЭлемента.Значение.ТипЭлемента);
	СвойстваКОбработке = Новый Структура(Новый ФиксированнаяСтруктура(ОписаниеЭлемента.Значение.ПредставленияСвойствЭлемента));
	
	// ОбязательныеСвойства
	Для Каждого Элемент Из ОписаниеСвойствЭлементаФормы.ОбязательныеСвойства Цикл
		ИмяОбязательногоСвойства = Элемент.Ключ;
		Для Каждого Синоним Из Элемент.Значение.Синонимы Цикл
			Если Не СвойстваКОбработке.Свойство(Синоним) Тогда
				Продолжить;
			КонецЕсли;
			ЗначениеСвойства = МодификацияФормОбработкаСвойствЭлемента.ЗначениеСвойства(
			  ОписаниеЭлемента.Значение.ТипЭлемента, 
